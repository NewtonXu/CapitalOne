...
should be treated as multiline comments as given in the Java example. 
...
Handling strings
========================
I have added a context search which will identify if a comment symbol is a 
...
to handle this if needed. Presents some problems if string and comment symbols
overlap.
...
blocks are treated as one if they are consecutive, regardless of indentation

Any line with a TODO in the comment portion will be treated as a TODO line.
'''
#Magic values
MULTILINESTR = -2
NOCOMMENT = -1
...
class CommentCounter:
    ...
    def useMultilineFSM(self,input:bool)->None:
        '''
    ...
    def loadSingleLineComment(self, input:str)->None:
        '''
        String which represents the start of a single line comment
        '''
        self.singleLineComment = input
    
    def loadMultiLineComment(self, start_symbol:str, end_symbol:str)->None:
        '''
    ...
    def loadTODO(self, input:str)->None:
        '''
        Load a different string to represent the TODO
        '''
        self.TODO = input
    
    def loadMultiLineStrings(self, start:str, end:str)->None:
        self.multiLineStringStart = start
        self.multiLineStringEnd = end
    
    def loadCustomSymbols(self, singleLine:str, 
        multiLineStart:str, multiLineEnd:str)->None:
        '''
        Load a set of symbols for your favourite programming language
        Fill out all options:
        For example for Python, fill out as #,#,#
        For HTML, fill out as <!--, <!--, -->
        '''
        self.loadSingleLineComment(singleLine)
        self.loadMultiLineComment(multiLineStart, multiLineEnd)
        
    def loadPythonCommentPreset(self)->None:
        '''
    ...
    def loadCPPCommentPreset(self)->None:
        '''
    ...
    def commentSearch(self,line:str)->tuple:
        '''
    ...
    def runFSM(self,filename:str)->None:
        '''
